...
HD_PWD='C:/Users/david/basys_serial/basys_serial.runs/block_design_uart_rx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_uart_rx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_uart_rx_0_0.tcl
