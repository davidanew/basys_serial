...
HD_PWD='C:/Users/david/basys_serial/basys_serial.runs/block_design_util_ds_buf_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_util_ds_buf_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_util_ds_buf_0_1.tcl
